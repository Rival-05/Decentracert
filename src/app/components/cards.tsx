...
export const Cards = () => {
  return (
    <div className="grid gap-6 px-4 py-8 sm:gap-8 sm:px-6 md:grid-cols-3 md:gap-10">
      <div className="rounded-md bg-cyan-900/10 p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-cyan-300/90">
            Tamper-Proof
          </h3>
        </div>
      ...
      <div className="rounded-md bg-green-900/10 p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-green-300/90">
      ...
      <div className="rounded-md bg-yellow-900/10 p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-yellow-300/90">
            Accessible Anywhere
          </h3>
        </div>
        <p className="text-sm text-neutral-500 sm:text-base">
